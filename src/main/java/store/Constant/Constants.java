...
public class Constants {
    ...
    public static final String RECEIPT_START_FORM = "==============W 편의점================\n"
            + "상품명\t\t수량\t\t\t금액";
    public static final String ORDER_FORM = "%-10s\t%4d\t%,8d\n"; // 상품명 왼쪽 정렬, 수량과 금액 오른쪽 정렬
    public static final String PRESENTATION_DIVISION_LINE = "=============증	정===============";
    public static final String GIVEAWAY_FORM = "%-10s\t%4d\n"; // 증정 상품 정렬
    public static final String DIVISION_LINE = "====================================";
    public static final String TOTAL_PURCHASE = "총구매액\t\t%4d\t%,8d\n"; // 총구매액 줄 정렬
    public static final String EVENT_DISCOUNT = "행사할인\t\t\t\t\t-%s\n"; // 할인 금액에 -를 포함하여 출력
    public static final String MEMBERSHIP_DISCOUNT = "멤버십할인\t\t\t\t-%s\n"; // 할인 금액에 -를 포함하여 출력
    public static final String TOTAL_PAYMENT = "내실돈\t\t\t\t%,8d\n"; // 최종 결제 금액 오른쪽 정렬
